...
const fiple = {
  ...
  init(ctx) {
    ...
    if (!ctx[0])
      return this.htmlError('Render tree is empty.<br><a class="fiple_link" href="https://marshallovski.github.io/fiplejs/docs/?err=RtreeEmpty" target="_blank">Learn more</a>');
  },
