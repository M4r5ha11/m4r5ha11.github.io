...
!function () {
  ...
  r.prototype = {
    ...
    goto: function (t) {
      ...
      this.index = t,
      t > - 1 && e.length > 0 && (e[t].setAttribute('aria-selected', 'true'), this.status.textContent = e[t].textContent + ', list item ' + (t + 1) + ' of ' + e.length, this.input.setAttribute('aria-activedescendant', this.ul.id + '_item_' + this.index), this.ul.scrollTop = e[t].offsetTop - this.ul.clientHeight + e[t].clientHeight, i.fire(this.input, 'awesomplete-highlight', {
